...
| [Package Configs (Machine)][package-metadata]    | Machine (Persistent)    | `PackageConfigs/{packageId}` | Config/Save files for external Tools installed as packages.              |
| [Package Configs (User)][package-metadata]       | User                    | `PackageConfigs/{packageId}` | Config/Save files for external Tools installed as packages.              |
